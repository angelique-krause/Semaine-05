...
let myHeaders = new Headers({"Content-Type"}: "application/json"); /* je crée un objet (je défini ma variable myHeaders) à l'intérieur du contructeur cad des parenthèses ; entre "" se sont les méthadonnées */
...
document.getElementById("submit-btn").addEventListener("click", () => {
  ...
  let auteurValue = document.getElementById("auteur").value;/* je pointe vers auteur */
})
